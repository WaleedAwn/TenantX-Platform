...
using TenantX.Api.OpenApi.Transformers;
using TenantX.Common.Infrastructure;

namespace TenantX.Api;


public static class DependencyInjection
{
	public static IServiceCollection AddCoreWebApiInfrastructure(
			...
			params string[] activityModuleNames)
	{
		...
		services.AddCoreInfrastructure(connectionString)
						...
						.AddAppRateLimiting()
						.AddAppOutputCaching()
						.AddAppOpenTelemetry(activityModuleNames);
	...
	public static IServiceCollection AddAppOpenTelemetry(this IServiceCollection services, params string[] activityModuleNames)
	{
		services
			.AddOpenTelemetry()
			.WithMetrics(metrics =>
	...
	public static IApplicationBuilder UseCoreMiddlewares(this IApplicationBuilder app, IWebHostEnvironment environment)
	{
